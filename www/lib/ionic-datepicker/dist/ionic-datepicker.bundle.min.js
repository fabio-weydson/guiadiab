...
angular.module("ionic-datepicker.provider", []).provider("ionicDatePicker", function() {
    ...
    ,
    this.$get = ["$rootScope", "$ionicPopup", "$ionicModal", "IonicDatepickerService", function(t, n, o, a) {
        function i(e) {
            return e.setHours(0),
            e.setMinutes(0),
            e.setSeconds(0),
        ...
        function c(e) {
            e.disabledDates && 0 !== e.disabledDates.length ? (u.disabledDates = [],
            angular.forEach(e.disabledDates, function(e, t) {
                e = i(new Date(e)),
                u.disabledDates.push(e.getTime())
            })) : u.disabledDates = []
        }
        function d(e) {
        	console.log(u.mainObj)
            e = i(e),
            u.currentDate = angular.copy(e);
            var t = new Date(e.getFullYear(),e.getMonth(),1).getDate()
              , n = new Date(e.getFullYear(),e.getMonth() + 1,0).getDate();
            u.monthsList = [],
            u.mainObj.monthsList && 12 === u.mainObj.monthsList.length ? u.monthsList = u.mainObj.monthsList : u.monthsList = a.monthsList,
            u.yearsList = a.getYearsList(u.mainObj.from, u.mainObj.to),
            console.log(u.yearsList);
            u.dayList = [];

            var o, c;
            u.firstDayEpoch = i(new Date(e.getFullYear(),e.getMonth(),t)).getTime(),
            u.lastDayEpoch = i(new Date(e.getFullYear(),e.getMonth(),n)).getTime();
            for (var d = t; n >= d; d++)
                o = new Date(e.getFullYear(),e.getMonth(),d),
                c = o.getTime() < u.fromDate || o.getTime() > u.toDate || u.mainObj.disableWeekdays.indexOf(o.getDay()) >= 0,
                u.dayList.push({
                    date: o.getDate(),
                    month: o.getMonth(),
                    year: o.getFullYear(),
            ...
            var r = u.dayList[0].day - u.mainObj.mondayFirst;
            r = 0 > r ? 6 : r;
            for (var l = 0; r > l; l++)
                u.dayList.unshift({});
            u.rows = [0, 7, 14, 21, 28, 35],
            u.cols = [0, 1, 2, 3, 4, 5, 6],
            u.currentMonth = u.mainObj.monthsList[e.getMonth()],
            u.currentYear = e.getFullYear().toString(),
            u.currentMonthSelected = angular.copy(u.currentMonth),
            u.currentYearSelected = angular.copy(u.currentYear),
            u.numColumns = 7
        }
        function r(e) {
            u.mainObj = angular.copy(e),
            u.selctedDateEpoch = i(u.mainObj.inputDate).getTime(),
            u.mainObj.weeksList && 7 === u.mainObj.weeksList.length ? u.weeksList = u.mainObj.weeksList : u.weeksList = ["S", "M", "T", "W", "T", "F", "S"],
            u.mainObj.mondayFirst && u.weeksList.push(u.mainObj.weeksList.shift()),
            u.disableWeekdays = u.mainObj.disableWeekdays,
            d(u.mainObj.inputDate),
            c(u.mainObj)
        }
        function l() {
            u.modal.show()
        ...
        var s = {}
          , u = t.$new();
        return u.today = i(new Date).getTime(),
        u.disabledDates = [],
        u.prevMonth = function() {
            1 === u.currentDate.getMonth() && u.currentDate.setFullYear(u.currentDate.getFullYear()),
            u.currentDate.setMonth(u.currentDate.getMonth() - 1),
            u.currentMonth = u.mainObj.monthsList[u.currentDate.getMonth()],
            u.currentYear = u.currentDate.getFullYear(),
            d(u.currentDate)
        }
        ,
        u.nextMonth = function() {
            11 === u.currentDate.getMonth() && u.currentDate.setFullYear(u.currentDate.getFullYear()),
            u.currentDate.setDate(1),
            u.currentDate.setMonth(u.currentDate.getMonth() + 1),
            u.currentMonth = u.mainObj.monthsList[u.currentDate.getMonth()],
            u.currentYear = u.currentDate.getFullYear(),
            d(u.currentDate)
        ...
        ,
        u.dateSelected = function(e) {
            e && 0 !== Object.keys(e).length && (u.selctedDateEpoch = e.epoch,
            u.mainObj.closeOnSelect && (u.mainObj.callback(u.selctedDateEpoch),
            "popup" == u.mainObj.templateType.toLowerCase() ? u.popup.close() : p()))
        }
        ,
        u.setIonicDatePickerTodayDate = function() {
            var e = new Date;
            d(new Date),
            u.selctedDateEpoch = i(e).getTime(),
            u.mainObj.closeOnSelect && (u.mainObj.callback(u.selctedDateEpoch),
            p())
        }
        ,
        u.setIonicDatePickerDate = function() {
            u.mainObj.callback(u.selctedDateEpoch),
            p()
        }
        ,
        u.monthChanged = function(e) {
            var t = u.monthsList.indexOf(e);
            u.currentDate.setMonth(t),
            d(u.currentDate)
        }
        ,
        u.yearChanged = function(e) {
            u.currentDate.setFullYear(e),
            d(u.currentDate)
        }
        ,
        o.fromTemplateUrl("ionic-datepicker-modal.html", {
            scope: u,
        ...
        u.closeIonicDatePickerModal = function() {
            p()
        }
        ,
        s.openDatePicker = function(t) {
            var o = [];
            delete u.fromDate,
            delete u.toDate,
            u.mainObj = angular.extend({}, e, t),
      
            console.log(u.fromDate),
            t.disableWeekdays && e.disableWeekdays && (u.mainObj.disableWeekdays = t.disableWeekdays.concat(e.disableWeekdays)),
            r(u.mainObj),
            u.mainObj.closeOnSelect || (o = [{
                text: u.mainObj.setLabel,
                type: "button_set",
                onTap: function(e) {
                    u.mainObj.callback(u.selctedDateEpoch)
                }
            }]),
            u.mainObj.showTodayButton && o.push({
                text: u.mainObj.todayLabel,
                type: "button_today",
                onTap: function(e) {
                    var t = new Date;
                    d(new Date),
                    u.selctedDateEpoch = i(t).getTime(),
                    u.mainObj.closeOnSelect || e.preventDefault()
                }
            }),
            o.push({
                text: u.mainObj.closeLabel,
                type: "button_close",
                onTap: function(e) {
                    console.log("ionic-datepicker popup closed.")
                }
            }),
            "popup" == u.mainObj.templateType.toLowerCase() ? u.popup = n.show({
...
angular.module("ionic-datepicker.service", []).service("IonicDatepickerService", function() {
    ...
    this.getYearsList = function(e, t) {
        ...
        o = o,
        a = y-18;
        // o = e ? new Date(e).getFullYear() : o,
        // a = t ? new Date(t).getFullYear() : a;
        for (var i = o; a >= i; i++)
            n.push(i);
        return n
    }
